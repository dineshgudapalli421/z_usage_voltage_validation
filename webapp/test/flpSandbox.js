		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Usage Voltage Validation",
									"targetURL": "#comsaplhmrzvoltagevalidation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhmrzvoltagevalidation-display": {
								"semanticObject": "comsaplhmrzvoltagevalidation",
								"action": "display",
								"description": "Usage Voltage Validation",
								"title": "Usage Voltage Validation",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.mr.zvoltagevalidation",
									"url": sap.ui.require.toUrl("com/sap/lh/mr/zvoltagevalidation")
								}
							}
						}
					}
